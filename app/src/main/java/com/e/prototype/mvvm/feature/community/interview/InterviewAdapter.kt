...
class InterviewAdapter(private val onClick: (Post) -> Unit):
    ListAdapter<Post, InterviewAdapter.ViewHolder>(InterviewDiffCallback){
...
object InterviewDiffCallback : DiffUtil.ItemCallback<Post>() {
